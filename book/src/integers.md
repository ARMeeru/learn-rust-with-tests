...
```rust
{{#include ../../chapters/03-integers/v1/src/lib.rs:test}}
```
...
```rust
{{#include ../../chapters/03-integers/v1/src/lib.rs:code}}
```
...
```rust
{{#include ../../chapters/03-integers/v2/src/lib.rs:code}}
```
...
```rust
{{#include ../../chapters/03-integers/v3/src/lib.rs:code}}
```
...
```rust
{{#include ../../chapters/03-integers/v4/src/lib.rs:code}}
```
...
```rust
{{#include ../../chapters/03-integers/v5/src/lib.rs:overflow_test}}
```
...
```rust
{{#include ../../chapters/03-integers/v6/src/lib.rs:code}}
```
